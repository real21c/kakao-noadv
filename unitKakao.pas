...
procedure TfrmRemoveKakaoAD.closeKakaoNoAd;
begin
  Close;
end;
...
procedure TfrmRemoveKakaoAD.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (ssCtrl in Shift) And ((Key = 87) or (Key = 124)) then begin
    closeKakaoNoAd;
  end;
end;
